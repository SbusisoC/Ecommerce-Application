...
public class TinyDB {
    ...
    public ArrayList<GiftDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<GiftDomain> playerList =  new ArrayList<GiftDomain>();

        for(String jObjString : objStrings){
            GiftDomain player  = gson.fromJson(jObjString,  GiftDomain.class);
    ...
    public void putListObject(String key, ArrayList<GiftDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(GiftDomain player: playerList){
